...
<div class="container mt-4">
    <h3>✏️ Modifier anniversaire</h3>
     <div class="alert alert-info">
        Résident : <b>(<?= $birthday['id_resident'] .") - " .$birthday['Prenom'] ." " .$birthday['Nom'] ." - " .$birthday['Gender'] ?></b><br>
        Date anniversaire : <b><?= sprintf('%02d-%02d-%d', (int)(new DateTime($birthday['Anniversaire']))->format('d'), $mois, $annee) ?></b>
    </div>
<form method="post" action="/birthday/update">
   ...
   <div class="row align-items-end g-2">
    <div class="col-auto">
        ...
        <input type="input" name="pax" class="form-control" value ="<?=  $birthday['pax'] ?>">
    </div>
    <div class="col-auto">
    ...
    <div class="col-auto">
        ...
        <?php foreach ($options['Heure'] as $h): ?>
                    <option value="<?= e($h)?>" <?= ($birthday['heure'] == $h) ? 'selected':'';?>> <?= e($h) ?></option>
                <?php endforeach; ?>
        </select>
    </div>
    ...
    <div class="col-auto">
        ...
        <?php foreach ($options['Lieux'] as $h): ?>
                    <option value="<?= e($h)?>" <?= ($birthday['lieux'] == $h) ? 'selected':'';?>><?= e($h) ?></option>
                <?php endforeach; ?>
        </select>
    </div>
            <!-- BOISSONS -->
    <div class="card rounded-4 shadow-sm mb-3">
        ...
        <div class="card-body d-flex flex-wrap gap-3">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="tea" value="1" id="tea" <?= $birthday['tea'] ? 'checked':'';?>>
                <label class="form-check-label" for="tea">Tea</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="coffee" value="0">
                <input class="form-check-input" type="checkbox" name="coffee" value="1" id="coffee" <?= $birthday['coffee'] ? 'checked':'';?>>
                <label class="form-check-label" for="coffee">Coffee</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="pop" value="0">
                <input class="form-check-input" type="checkbox" name="pop" value="1" id="pop" <?= $birthday['pop'] ? 'checked':'';?>>
                <label class="form-check-label" for="pop">Pop</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="juice" value="0">
                <input class="form-check-input" type="checkbox" name="juice" value="1" id="juice" <?= $birthday['juice'] ? 'checked':'';?>>
                <label class="form-check-label" for="juice">Juice</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="milk" value="0">
                <input class="form-check-input" type="checkbox" name="milk" value="1" id="milk" <?= $birthday['milk'] ? 'checked':'';?>>
                <label class="form-check-label" for="milk">Milk</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="water" value="0">
                <input class="form-check-input" type="checkbox" name="water" value="1" id="water" <?= $birthday['water'] ? 'checked':'';?>>
    ...
    <div class="card rounded-4 shadow-sm mb-3">
        ...
        <div class="card-body d-flex flex-wrap gap-3">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="cake" value="1" id="cake" <?= $birthday['cake'] ? 'checked':'';?>>
                <label class="form-check-label" for="cake">Cake</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="sugar" value="0">
                <input class="form-check-input" type="checkbox" name="sugar" value="1" id="sugar" <?= $birthday['sugar'] ? 'checked':'';?>>
                <label class="form-check-label" for="sugar">Sugar</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="saltpepper" value="0">
                <input class="form-check-input" type="checkbox" name="saltpepper" value="1" id="saltpepper" <?= $birthday['saltpepper'] ? 'checked':'';?>>
    ...
    <div class="card rounded-4 shadow-sm mb-3" id="vaisselles">
        ...
        <div class="card-body d-flex flex-wrap gap-3">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="cups" value="1" id="cups" <?= $birthday['cups'] ? 'checked':'';?>>
                <label class="form-check-label" for="cups">Cups</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="juiceglass" value="0">
                <input class="form-check-input" type="checkbox" name="juiceglass" value="1" id="juiceglass" <?= $birthday['juiceglass'] ? 'checked':'';?>>
                <label class="form-check-label" for="juiceglass">Juice glass</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="foamglass" value="0">
                <input class="form-check-input" type="checkbox" name="foamglass" value="1" id="foamglass" <?= $birthday['foamglass'] ? 'checked':'';?>>
                <label class="form-check-label" for="foamglass">Foam glass</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="plasticdish6" value="0">
                <input class="form-check-input" type="checkbox" name="plasticdish6" value="1" id="plasticdish6" <?= $birthday['plasticdish6'] ? 'checked':'';?>>
                <label class="form-check-label" for="plasticdish6">Plastic dish 6"</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="plasticdish9" value="0">
                <input class="form-check-input" type="checkbox" name="plasticdish9" value="1" id="plasticdish9" <?= $birthday['plasticdish9'] ? 'checked':'';?>>
    ...
    <div class="card rounded-4 shadow-sm mb-3" id="ustensiles">
        ...
        <div class="card-body d-flex flex-wrap gap-3">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="knife" value="1" id="knife" <?= $birthday['knife'] ? 'checked':'';?>>
                <label class="form-check-label" for="knife">Knife</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="fork" value="0">
                <input class="form-check-input" type="checkbox" name="fork" value="1" id="fork" <?= $birthday['fork'] ? 'checked':'';?>>
                <label class="form-check-label" for="fork">Fork</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="teaspoon" value="0">
                <input class="form-check-input" type="checkbox" name="teaspoon" value="1" id="teaspoon" <?= $birthday['teaspoon'] ? 'checked':'';?>>
                <label class="form-check-label" for="teaspoon">Teaspoon</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="cakeknife" value="0">
                <input class="form-check-input" type="checkbox" name="cakeknife" value="1" id="cakeknife" <?= $birthday['cakeknife'] ? 'checked':'';?>>
                <label class="form-check-label" for="cakeknife">Cake knife</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="napkin" value="0">
                <input class="form-check-input" type="checkbox" name="napkin" value="1" id="napkin" <?= $birthday['napkin'] ? 'checked':'';?>>
    ...
    <div class="card rounded-4 shadow-sm mb-3" id="lingeDivers">
        ...
        <div class="card-body d-flex flex-wrap gap-3">
            ...
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" name="tablecloth" value="1" id="tablecloth" <?= $birthday['tablecloth'] ? 'checked':'';?>>
                <label class="form-check-label" for="tablecloth">Tablecloth</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="greycenter" value="0">
                <input class="form-check-input" type="checkbox" name="greycenter" value="1" id="greycenter" <?= $birthday['greycenter'] ? 'checked':'';?>>
                <label class="form-check-label" for="greycenter">Grey center</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="trashbag" value="0">
                <input class="form-check-input" type="checkbox" name="trashbag" value="1" id="trashbag" <?= $birthday['trashbag'] ? 'checked':'';?>>
                <label class="form-check-label" for="trashbag">Trash bag</label>
            </div>

            <div class="form-check">
                <input type="hidden" name="kitchencloth" value="0">
                <input class="form-check-input" type="checkbox" name="kitchencloth" value="1" id="kitchencloth" <?= $birthday['kitchencloth'] ? 'checked':'';?>>
    ...
    <div class="form-group mb-6">
        <label class="form-label">Informations<input type="input" name="informations" class="form-control" value ="<?=  $birthday['informations'] ?>"></label>
    </div>
    <div class="mt-3">
