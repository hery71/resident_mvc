...
<div class="container mt-4">
  <div class="card-modern">
    ...
    <div class="card-body">
      ...
      <a href="/resident/printIndex?nom=<?= urlencode($nom) ?>&prenom=<?= urlencode($prenom) ?>&page=<?= $page ?>"
         class="NP btn btn-info mb-3"
         target="_blank">
        🖨 Imprimer
      </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-bordered">
          <tr><th>Prénom</th><td id="info-prenom"></td></tr>
          <tr><th>Nom</th><td id="info-nom"></td></tr>
          <tr><th>Date anniversaire</th><td id="info-anniversaire"></td></tr>
          <tr><th>Téléphone 1</th><td id="info-tel1"></td></tr>
