            ...
            <div class="form-group col-md-3">
                ...
                <select name="motif" class="form-control">
                    <?php foreach ($options['Motif'] as $h): ?>
                        <option value="<?= e($h)?>" <?= ($fete['motif'] == $h) ? 'selected':'';?>>
                            <?= e($h) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group col-md-4">
                ...
                <select name="id_resident" class="form-control">
                    ...
                    <?php foreach ($resident as $a): ?>
                        <option value="<?= e($a['id'])?>" <?= ($fete['id_resident'] == $a['id']) ? 'selected':'';?>>
                            <?= e($a['Prenom'] ." " .$a['Nom']) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group col-md-3">
                ...
                <select name="heure" class="form-control">
                    <?php foreach ($options['Heure'] as $h): ?>
                        <option value="<?= e($h)?>" <?= ($fete['heure'] == $h) ? 'selected':'';?>>
                            <?= e($h) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group col-md-4">
                ...
                <select name="lieux" class="form-control">
                    <?php foreach ($options['Lieux'] as $h): ?>
                        <option value="<?= e($h)?>" <?= ($fete['lieux'] == $h) ? 'selected':'';?>>
                            <?= e($h) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-check">
            ...
            <input class="form-check-input" type="checkbox" name="<?= $k ?>" value="1" <?= $fete[$k] ? 'checked':'';?>>
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <input type="input" name="informations" class="form-control" value="<?= $fete['informations'] ?>">
    </div>
</div>
